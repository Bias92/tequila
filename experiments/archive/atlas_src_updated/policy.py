...
=====================================
Lightweight MLP: 395-d → 128 → 64 → 1 → Sigmoid
Scores each summary in buffer. Low score = evict.

Input features per summary (395-d):
  ...
  [389:395] type one-hot (agenda_item, detail, medication, social_history, follow_up, question_unanswered)
"""
